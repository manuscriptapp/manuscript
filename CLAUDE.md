...
The marketing site lives in `website/` and uses Jekyll with custom HTML.
- Config: `website/_config.yml`
...
- `FEATURE_PARITY.md` - Comprehensive feature matrix tracking parity with Scrivener and Ulysses (use ✅/🔜/❌ status markers)
